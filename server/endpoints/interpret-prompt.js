// Import required modules
    ...
    const OpenAI = require('openai'); // OpenAI SDK for interacting with GPT
    const router = express.Router(); // Create a router instance for modular route handling
    ...
    router.post('/', async (req, res) => {
        ...
        try {
            ...
            // Extract the assistant's text reply from the response
                ...
                if (debug) console.log('GPT raw response:', gptText); // Debug: log GPT's raw reply
